...
//     const nftDeployTx = nftContract.deployTransaction;

//     // Wait for the transaction to be mined and get the receipt
//     const nftDeployReceipt = await nftDeployTx.wait();

//     // Log gas used and transaction cost
//     console.log("DecentradeNFT deployment gas used:", nftDeployReceipt.gasUsed.toString());
//     console.log("DecentradeNFT deployment transaction cost:", hre.ethers.utils.formatEther(nftDeployReceipt.gasUsed.mul(nftDeployTx.gasPrice)) + " ETH");
...
//     // Get deployment transaction
//     const marketplaceDeployTx = marketplaceContract.deployTransaction;

//     // Wait for the transaction to be mined and get the receipt
//     const marketplaceDeployReceipt = await marketplaceDeployTx.wait();

//     // Log gas used and transaction cost
//     console.log("DecentradeMarketplace deployment gas used:", marketplaceDeployReceipt.gasUsed.toString());
//     console.log("DecentradeMarketplace deployment transaction cost:", hre.ethers.utils.formatEther(marketplaceDeployReceipt.gasUsed.mul(marketplaceDeployTx.gasPrice)) + " ETH");
...
//         nftDeployReceipt.gasUsed.mul(nftDeployTx.gasPrice).add(
//             marketplaceDeployReceipt.gasUsed.mul(marketplaceDeployTx.gasPrice)
//         )
//     );
...
async function main() {
    ...
    console.log("Deploying DecentradeNFT...");
    const nftContract = await DecentradeNFT.deploy();
    console.log("DecentradeNFT deployed to:", nftContract.getAddress());
