...
Please read and follow our [Code of Conduct.](https://github.com/4darsh-Dev/DecenTrade/blob/main/Code%20of%20Conduct.md)
...
│   
│
├── frontend/                   // Frontend code, likely React or Vue components
│
│   
├── scripts/                    // Scripts for project automation, deployment, or setup
│                           
│
├── smart-contracts/            // Solidity or Vyper contracts for decentralized trade
│ 
│
├── .deepsource.toml
├── .gitignore
...
```bash
git clone https://github.com/<your-github-username>/DecenTrade.git
```
...
- Admin :- Adarsh Maurya
- Contact :- [Email](adarsh@onionreads.com)
...
1. Navigate to the project's issues section :- [Issues](https://github.com/4darsh-Dev/DecenTrade/issues)
